...
import com.example.qa.other.Constants;
import com.example.qa.other.Utils;
...
public class MathQuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPrevious = findViewById(R.id.btnPreviousQuestionMath);
        ...
        btnPrevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentQuestionIndex > 0) {
                    currentQuestionIndex--;
                    if (questionsAnswerMap.get(questions.get(currentQuestionIndex)).equals(userAnswers.get(currentQuestionIndex))) {
                        correctQuestion--;
                    }
                    displayPreviousQuestions();
                } else {
                    Toast.makeText(MathQuizActivity.this, "This is the first question", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void displayPreviousQuestions() {
        etAnswer.setText(userAnswers.get(currentQuestionIndex));
        tvQuestion.setText(questions.get(currentQuestionIndex) + " = ?");
        tvQuestionNumber.setText("Current Question: " + (currentQuestionIndex + 1));
